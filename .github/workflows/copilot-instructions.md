...
- **Function-First Aesthetics:** All visual design must serve functional practicality, eliminating purely decorative elements.

- **Minimalist Implementation:** Adopt a "less is more" approach, retaining only essential interface elements.

- **Systematic Consistency:** Ensure all components follow a unified visual language.

### Visual Guidelines

**Style References:** Notion, Linear

**Color Scheme:** Solid color background, no gradient effects.

**Visual Effects:** Completely flat design, avoiding skeuomorphic effects.

- No use of gradients, gloss, textures, or other decorative elements.

- Shadow Usage Restrictions: Slight or no shadows, used only for necessary layering.
